...
server.tool(
  'get_market_prices',
  'Get current market prices for a specific commodity in different regions (e.g., coconut, soap, palm oil)',
  { commodity: z.string().describe('Name of the commodity') },
  async ({ commodity }) => {
...
server.tool(
  'get_news_summary',
  'Get a summary of recent news affecting a specific industry or commodity',
  { topic: z.string().describe('Industry or commodity topic') },
  async ({ topic }) => {
