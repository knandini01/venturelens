...
server.tool(
  ...
  'Estimate the distance, duration, and cost of transporting goods between two cities in India',
  {
...
server.tool(
  'book_transport',
  'Book a transport vehicle for a specific transaction. Requires user confirmation.',
  {
...
server.tool(
  'track_shipment',
  'Get the current status of a transport booking',
