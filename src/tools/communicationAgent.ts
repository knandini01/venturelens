...
export function registerCommunicationTools(server: McpServer): void {
  server.tool(
    "contactDealer",
    "Generate and simulate sending a business message (email/SMS/WhatsApp) to a buyer, supplier, or transporter. Produces a ready-to-send professional message with your proposal.",
    {
