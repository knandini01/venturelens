...
import { AgentLoop, AgentResponse, ConfirmationGate } from './agent-loop.js';
...
const workflowHistory: AgentResponse[] = [];

// Store pending confirmations by workflowId
const pendingConfirmationsByWorkflow = new Map<string, ConfirmationGate[]>();
