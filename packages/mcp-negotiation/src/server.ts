...
server.tool(
  ...
  'Start a negotiation with a buyer or supplier for a specific product and price. Requires user confirmation.',
  {
...
server.tool(
  'accept_offer',
  'Accept an offer or counter-offer to close the negotiation. Requires user confirmation.',
